...
class SmartCompressor:
    ...
    def paq_compress(self, data):
        try:
            ...
            logging.error("PAQ module not available. Falling back to zlib.")
            return self.compress_data_zlib(data)
    ...
    def paq_decompress(self, data):
        try:
            ...
            logging.error("PAQ module not available. Falling back to zlib.")
            return self.decompress_data_zlib(data)
    ...
    def decompress_with_best_method(self, data):
        if len(data) < 1:
            logging.error("Empty compressed data.")
            return b''
...
def main():
    ...
    print("Options:")
    print("1 - Compress file (PAQJP_1 with transformations)")
    print("2 - Decompress file (PAQJP_1 with transformations)")
